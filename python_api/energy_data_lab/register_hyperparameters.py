...
def register_hyperparameters(
    ...
    """
    Registers a hyperparameter artifact in the Energy Data Lab.
    ...
    hyperparameters : list
        List of hyperparameters. Expected format: [{"name": "name as string", "value": x}, ...],
        where x can be a string, int, float, or bool.
    ...
    response = requests.post(
        "http://localhost:8080/hyperparameter-artifacts",
        json=result,
    )
